...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "38600231"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","fce4e9695e9092a00e9428d1671d4c45")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Ashishhyyo_bot")
BOT_TEXT = ""
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "1050556642"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-8614605594"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-8614605594")) 
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-8614605594"))
# -----------------------------------------------
...
# BOT_USERNAME = os.environ.get("BOT_USERNAME", "Ashishhyyo_bot")
# OWNER_ID = int(os.environ.get("OWNER_ID", "1050556642"))
# SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1050556642").split()))
# CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-8614605594"))
